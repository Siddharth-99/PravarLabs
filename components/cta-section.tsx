  ...
  return (
    <section id="contact" className="py-20 lg:py-28">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl bg-primary px-6 py-16 sm:px-16 sm:py-24 lg:py-28">
          ...
          <div className="mx-auto max-w-3xl text-center relative">
            <div className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-1.5 text-sm font-medium text-primary-foreground/90 border border-white/20 mb-6">
              Get Started Today
            </div>
            ...
            <p className="mx-auto mt-6 max-w-xl text-lg text-primary-foreground/80 text-pretty">
              Let&apos;s discuss how PravarAi Labs can help you unlock the full potential of your data and accelerate your AI journey.
            </p>
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button 
                size="lg" 
                variant="secondary" 
                className="gap-2 px-8 h-12 text-base bg-white text-primary hover:bg-white/90"
                asChild
              >
                <Link href="/demo">
